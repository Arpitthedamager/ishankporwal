    ...
    <section className="hero-section relative pb-8 pt-32 bg-gray-100 overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="relative mt-32 mx-auto max-w-7xl">
          ...
          <div className="absolute -z-10 left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 rotate-[4deg] w-full h-full bg-green-300 opacity-50 rounded-2xl"></div>
